...
var currdeg = 0;
var btnNext = document.getElementById("nextClick");
var btnPrev = document.getElementById("prevClick");

btnNext.addEventListener("click", rotate);
btnPrev.addEventListener("click", rotate);

function rotate(e){
    console.log(e);
    if(e.target.id == "nextClick"){
        currdeg -= 90;
        console.log(currdeg);
    }
